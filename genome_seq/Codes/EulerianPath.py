...
#print(EulerianGraphs(graph,"path"))

with open(repo+"/genome_seq/inputs/eulerpath.txt","r") as reader:
    graph_input=list(map(str.strip,reader.readlines()))
    graph_output=EulerianGraphs(graph_input,mode="path")
with open(repo+"/genome_seq/outputs/eulerpath_solve.txt","w") as writter:
