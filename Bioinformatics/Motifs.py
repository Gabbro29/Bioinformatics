...
pro= { 'A': [0.8, 0.0, 0.0, 0.2 ],'C': [ 0.0, 0.6, 0.2, 0.0], 'G': [ 0.2 ,0.2 ,0.8, 0.0], 'T': [ 0.0, 0.2, 0.0, 0.8]}  
Dna= ['ATGAGGTC','GCCCTAGA','AAATAGAT','TTGTGCTA']
moti=['GTC','CCC','ATA','GCT']

#print(ProfileWithPseudocounts(moti))


print(Motifs(ProfileWithPseudocounts(moti),Dna))